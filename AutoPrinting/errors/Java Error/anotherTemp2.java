...
public class TextTransform implements TextMapper {
	...
	public static class Edit {
		...
		public int index() {
      System.out.println("xxx TextTransform.Edit.index");
			return index;
		}
		
		public int beforeLength() {
      System.out.println("xxx TextTransform.Edit.beforeLength");
			return beforeLength;
		}
		
		public int afterLength() {
      System.out.println("xxx TextTransform.Edit.afterLength");
			return afterLength;
		}
		
		public CharSequence before() {
      System.out.println("xxx TextTransform.Edit.before");
			return before;
		}
		
		public CharSequence after() {
      System.out.println("xxx TextTransform.Edit.after");
			return after;
		}
		
		private Edit(int index, CharSequence before, CharSequence after) {
      System.out.println("xxx TextTransform.Edit.Edit");
			this.index = index;
			this.before = before;
			this.after = after;
      ...
      System.out.println("xxx TextTransform.Edit.hasMoveLink");
			return moveLink != null;
		}
		
		public Edit getMoveLink() {
      System.out.println("xxx TextTransform.Edit.getMoveLink");
			return moveLink;
		}
		
		public void apply(StringBuilder text, boolean forward) {
      System.out.println("xxx TextTransform.Edit.apply");
      ...
      System.out.println("xxx TextTransform.Edit.directionalLength");
			return forward ? afterLength() : beforeLength();
		}
		
		public int directionlLengthDiff(boolean forward) {
      System.out.println("xxx TextTransform.Edit.directionlLengthDiff");
			return directionalLength(forward) - directionalLength(!forward);
		}
		
		public CharSequence directionalText(boolean forward) {
      System.out.println("xxx TextTransform.Edit.directionalText");
			return forward ? after() : before();
		}
		
		public Edit weight(int weight) {
      System.out.println("xxx TextTransform.Edit.weight");
			this.weight = weight;
			return this;
		}
		
		public int getWeight() {
      System.out.println("xxx TextTransform.Edit.getWeight");
			return weight;
		}
		
		@Override
		public Edit clone() {
      System.out.println("xxx TextTransform.Edit.clone");
			return new Edit(index, before, after);
		}
		
		@Override
		public String toString() {
      System.out.println("xxx TextTransform.Edit.toString");
	...
	public static class MoveEdit extends ArrayList<Edit> {
      ...
      System.out.println("xxx TextTransform.MoveEdit.getRemove");
			if (size() != 2) {
      ...
      System.out.println("xxx TextTransform.MoveEdit.getInsert");
			if (size() != 2) {
				throw new RuntimeException("MoveEdit tampered with");
			}
			return get(1);
	...
	public static class Range {
      ...
      System.out.println("xxx Edit.Range");
			this.index = index;
			this.length = length;
		}
		
		public int index() {
      System.out.println("xxx Edit.index");
			return index;
		}
		
		public int length() {
      System.out.println("xxx Edit.length");
			return length;
		}
		
		@Override
		public String toString() {
      System.out.println("xxx Edit.toString");
